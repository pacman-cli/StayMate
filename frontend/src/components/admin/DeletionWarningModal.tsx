...
export function DeletionWarningModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="bg-white dark:bg-dark-900 rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 dark:border-dark-700 overflow-hidden">
        {/* Header */}
        <div className="p-6 bg-amber-50 dark:bg-amber-900/10 border-b border-amber-100 dark:border-amber-900/20 flex items-start gap-4">
          <div className="p-3 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-500 rounded-full shrink-0">
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <div className="p-3 bg-slate-50 dark:bg-dark-800 rounded-lg border border-slate-200 dark:border-dark-700 font-mono text-sm">
              {userName}
            </div>
          </div>

          <div className="flex items-start gap-3 p-4 bg-slate-50 dark:bg-dark-800/50 rounded-lg">
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full p-2.5 rounded-lg border border-slate-200 dark:border-dark-700 bg-white dark:bg-dark-800 text-sm focus:ring-2 focus:ring-amber-500 outline-none"
            >
          ...
          <label className="flex items-start gap-3 p-4 rounded-lg border border-slate-200 dark:border-dark-700 cursor-pointer hover:bg-slate-50 dark:hover:bg-dark-800/50 transition-colors">
            <input
              type="checkbox"
              checked={isConfirmed}
        ...
        {/* Footer */}
        <div className="p-6 border-t border-slate-100 dark:border-dark-700 flex justify-end gap-3 bg-slate-50/50 dark:bg-dark-900">
          <button
            onClick={onClose}
