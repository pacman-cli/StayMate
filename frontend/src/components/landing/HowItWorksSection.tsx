...
export default function HowItWorksSection() {
 ...
 return (
  <section
   className={`py-32 relative overflow-hidden ${isDark ? "bg-dark-950" : "bg-white"
    }`}
  >
        ...
        <div className="relative mb-8">
         <motion.div
          ...
          className={`w-32 h-32 rounded-3xl flex items-center justify-center relative z-10 transition-colors duration-300 ${isDark
           ? "bg-dark-900 border border-white/10 group-hover:border-primary-500/50"
           : "bg-white border border-slate-200 shadow-xl group-hover:border-primary-200"
           }`}
         >
