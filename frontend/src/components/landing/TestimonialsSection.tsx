...
export default function TestimonialsSection() {
  ...
  return (
    <section
      className={`py-32 relative overflow-hidden transition-colors duration-300 ${isDark ? "bg-dark-800" : "bg-slate-50"}`}
    >
          ...
          {testimonials.map((testimonial, idx) => (
            <motion.div
              ...
              className={`relative p-8 rounded-3xl transition-all duration-300 h-full flex flex-col ${isDark
                ...
                : "bg-white border border-slate-100 shadow-lg hover:shadow-2xl"
                }`}
            >
              <Quote
