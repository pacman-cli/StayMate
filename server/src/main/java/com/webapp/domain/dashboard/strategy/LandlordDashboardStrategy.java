...
public class LandlordDashboardStrategy implements DashboardStrategy {
    ...
    public DashboardStats aggregate(User user) {
        ...
        propertyStatusStats.put("Active", propertyRepository.countByOwnerIdAndStatus(user.getId(), "Active"));
        propertyStatusStats.put("Pending", propertyRepository.countByOwnerIdAndStatus(user.getId(), "Pending"));
        propertyStatusStats.put("Rented", propertyRepository.countByOwnerIdAndStatus(user.getId(), "Rented"));
